...
同时特别感谢 [Folia](https://github.com/chthollyphile/folia-major)（作者 chthollyphile）的歌词可视化设计。本项目中的 Monet、Partita、Cadenza、Tilt、Pendolo 等歌词视觉样式参考并移植自 Folia 的 lyrics visualizer 实现。Folia 基于 [GNU Affero General Public License v3.0](https://www.gnu.org/licenses/agpl-3.0.html) 开源，相关移植与衍生代码请遵循其许可条款。
