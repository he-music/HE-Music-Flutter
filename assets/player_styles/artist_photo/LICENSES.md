...
- Fixed data: project logo artwork, Chinese track metadata, fixed playback position, fixed quality, paused hardware animation frame, fixed test fonts, and a deterministic five-line lyric document with word timing and translation shared by Monet and Partita.
...
- `assets/player_styles/partita_lyrics/preview.png`: `beb0ef727a9f58507ddf5849783615730fa25f447fb4d61a547cc9d01e17e0d7`.
...
- `test/features/player/presentation/goldens/player_styles/desktop_partita_lyrics.png`: `04700b34e5ded3c20c24164172c6dd1172eb6112ffe91279d50c32b7f9922a8c`.
- Technical inspection: all eight previews render readable fixed Chinese text, metadata badges, playback time and controls without blank regions or overflow. Monet and Partita use the deterministic five-line `LyricDocument` at `1:24`; their mobile previews open the full lyric page and their desktop goldens render a bounded rail beside the classic stage. Partita shows deterministic source-index cloud steps, a word-timed active accent, translation below the main line, readable nearby context, bounded L guides, a transparent host, and the cover-derived `PlayerScenePalette`.
