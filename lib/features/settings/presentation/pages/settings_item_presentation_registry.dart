...
final Map<String, SettingsItemPresentation>
settingsItemPresentations = <String, SettingsItemPresentation>{
  ...
  SettingsItemIds.skinAnimation: SettingsItemPresentation(
    subtitleBuilder: (config) {
      ...
      final supportsAnimation =
          skin.light.background.animation is AppSkinRiveAnimationDescriptor ||
  ...
  SettingsItemIds.monochrome: SettingsItemPresentation(
    subtitleBuilder: (config) => AppI18n.t(config, 'settings.monochrome.desc'),
  ),
  SettingsItemIds.playerBackgroundStyle: SettingsItemPresentation(
    subtitleBuilder: (config) =>
        _playerBackgroundStyleDescription(config.playerBackgroundStyle, config),
  ),
...
AppSkinIconRole settingsItemIconRole(String itemId) {
  return switch (itemId) {
    ...
    SettingsItemIds.playerBackgroundStyle =>
      AppSkinIconRole.settingsPlayerBackground,
