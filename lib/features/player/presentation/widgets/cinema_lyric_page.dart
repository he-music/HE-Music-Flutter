...
import '../../../lyrics/presentation/widgets/cinema_lyric_rail.dart';
import '../../../lyrics/presentation/widgets/lyric_search_empty.dart';
import '../providers/player_providers.dart';

class CinemaLyricPage extends ConsumerWidget {
  const CinemaLyricPage({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return _CinemaLyricDataHost(
      key: const ValueKey<String>('cinema-lyric-page'),
      emptyText: emptyText,
      onSeek: onSeek,
...
class _CinemaLyricDataHost extends ConsumerWidget {
  const _CinemaLyricDataHost({
    required this.emptyText,
    required this.onSeek,
    required this.palette,
