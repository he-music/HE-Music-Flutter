...
IconData classicIconForRole(AppSkinIconRole role) {
  return switch (role) {
    ...
    AppSkinIconRole.searchSubmit => Icons.arrow_forward_rounded,
    AppSkinIconRole.searchHistoryClear => Icons.delete_outline_rounded,
    ...
    AppSkinIconRole.queueClear => Icons.delete_sweep_rounded,
    ...
    AppSkinIconRole.batchDeselectAll => Icons.deselect_rounded,
    AppSkinIconRole.batchPlay => Icons.play_arrow_rounded,
    AppSkinIconRole.batchAddToQueue => Icons.queue_music_rounded,
    ...
    AppSkinIconRole.localLibraryScan => Icons.folder_open_rounded,
    AppSkinIconRole.localLibraryClear => Icons.clear_all_rounded,
    AppSkinIconRole.myDownloads => Icons.download_rounded,
    AppSkinIconRole.myCollection => Icons.favorite_border_rounded,
    AppSkinIconRole.myCollectionRefresh => Icons.refresh_rounded,
    AppSkinIconRole.myCollectionRemove => Icons.favorite_rounded,
    AppSkinIconRole.myPlaylist => Icons.queue_music_rounded,
    AppSkinIconRole.myPlaylistCreate => Icons.add_rounded,
