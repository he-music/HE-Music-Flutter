...
AppSkinBrightnessConfig _lightBrightnessConfig() {
  ...
  return AppSkinBrightnessConfig(
    ...
    colors: AppSkinColors(
      ...
      cardBackground: pearl.withValues(alpha: 0.6),
...
AppSkinBrightnessConfig _darkBrightnessConfig() {
  ...
  return AppSkinBrightnessConfig(
    ...
    colors: AppSkinColors(
      ...
      backgroundOverlay: overlay,
      cardBackground: scrollingSurface.withValues(alpha: 0.62),
      inputBackground: const Color(0xC2294A61),
      navigationBackground: const Color(0xD1294A61),
      navigationIndicator: const Color(0x3DF2CE67),
      bottomSheetBackground: const Color(0xED1B3041),
      dialogBackground: const Color(0xF0213A4C),
      divider: const Color(0x9949444E),
      snackBarBackground: const Color(0xFF29475A),
      fixedControlSurface: fixedSurface,
      scrollingContentSurface: scrollingSurface,
      border: const Color(0xFF607B8D),
      selectionIndicator: const Color(0xFF78D5E7),
      shadow: const Color(0xFF07111B),
    ),
    surfaces: const AppSkinSurfaces(
      searchOpacity: 0.76,
      miniPlayerOpacity: 0.78,
      navigationOpacity: 0.82,
      scrollingContentOpacity: 0.62,
