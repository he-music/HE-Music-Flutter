...
enum AppThemeAccent {
  ...
  midnight('midnight', '午夜', Color(0xFF334155), Color(0xFF94A3B8)),
  mint('mint', '薄荷', Color(0xFF059669), Color(0xFF6EE7B7)),
  cherry('cherry', '樱桃', Color(0xFFBE123C), Color(0xFFFF6B81)),
  graphite('graphite', '石墨', Color(0xFF3F3F46), Color(0xFFA1A1AA));
